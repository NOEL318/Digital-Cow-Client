...
import {
  ...
  Layers, CheckCircle2, Clock, Sparkles, Scale
} from 'lucide-react';
import {
    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <div className="glass-card p-4 border-l-4 border-l-emerald-600 flex items-center gap-3">
          ...
          <div>
            <div className="text-2xl font-black text-foreground">{kpis?.activeCropsHectares ?? 20.5} <span className="text-xs font-normal text-muted-foreground">ha</span></div>
        ...
        <div className="glass-card p-4 border-l-4 border-l-emerald-600 flex items-center gap-3">
          ...
          <div>
            <div className="text-2xl font-black text-foreground">{kpis?.totalTonsHarvested ?? 152.2} <span className="text-xs font-normal text-muted-foreground">Ton</span></div>
        ...
        <div className="glass-card p-4 border-l-4 border-l-emerald-600 flex items-center gap-3">
          ...
          <div>
            <div className="text-2xl font-black text-foreground">${(kpis?.totalCropRevenue ?? 753240).toLocaleString()}</div>
        ...
        <div className="glass-card p-4 border-l-4 border-l-emerald-600 flex items-center gap-3">
          ...
          <div>
            <div className="text-2xl font-black text-foreground">7.4 <span className="text-xs font-normal text-muted-foreground">t/ha</span></div>
