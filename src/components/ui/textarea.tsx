...
/** Textarea con estética glassmorphism y foco con resplandor esmeralda. */
export const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(
  ({ className, ...props }, ref) => (
    <textarea
      className={cn(
        'flex min-h-[90px] w-full rounded-xl border border-white/60 dark:border-white/15 bg-white/70 dark:bg-slate-900/60 p-3.5 text-sm text-foreground shadow-sm backdrop-blur-md transition-all duration-150',
